  ...
  return (
    <div style={styles.page}>
      ...
      <UploadCard
       file={file}
       setFile={setFile}
       onGenerate={generateStudyMaterial}
       loading={loading}
     />
...
function ActionCard({ label, icon, bg, onClick }) {
  return (
    <button style={styles.actionCard} onClick={onClick}>
      <div style={{ ...styles.actionIconWrap, background: bg }}>{icon}</div>
